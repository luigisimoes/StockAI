...
/**
 * Raw export-only version of the Lo-fi wireframes section.
 *
 * Same content as LoFiSection but WITHOUT the ExpandableSection
 * wrapper. Used by /lofi-export to render wireframes immediately
 * (no "Read more" click needed) so html.to.design can capture
 * them cleanly.
 *
 * Keep this in sync with LoFiSection.tsx if the wireframe markup
 * changes.
 */
export default function LoFiSectionRaw() {
  return (
    <section id="lo-fi" className="py-20 bg-[#F8FAFC]">
      <div className="max-w-[900px] mx-auto px-6">
        ...
        <h2 className="font-display text-3xl md:text-4xl font-bold text-graphite-900 mb-6 leading-tight">
          Blocks before pixels.
        </h2>

        <p className="text-lg text-graphite-700 leading-relaxed font-medium mb-6">
          Before opening Figma I locked the structure with simple block wireframes. Stat cards row, AI strip, tabs, content. The drawer came out of trying to fit deep review into a fourth screen and realizing a slide-over was the right answer.
        </p>
